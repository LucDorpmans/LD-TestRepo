...
Invoke-Webrequest -Uri "https://github.com/PowerShell/PowerShell/releases/download/v7.1.3/PowerShell-7.1.4-win-x64.msi"  -Outfile "$env:USERPROFILE\Downloads\$MyFile"
